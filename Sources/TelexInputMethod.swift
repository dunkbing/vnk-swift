...
class TelexInputMethod : NSObject {
    let DAU_SAC = g("s");
    let DAU_HUYEN = g("f");
    let DAU_HOI = g("r");
    let DAU_NGA = g("x");
    ...
    private func initToneMarks() {
        // Sắc (s key - rising tone)
        CONTROL_CHAR[DAU_SAC] = [
        ...
        // Huyền (f key - falling tone)
        CONTROL_CHAR[DAU_HUYEN] = [
        ...
        // Hỏi (r key - questioning tone)
        CONTROL_CHAR[DAU_HOI] = [
        ...
        // Ngã (x key - undulating tone)
        CONTROL_CHAR[DAU_NGA] = [
        ...
        // Nặng (j key - heavy tone)
        CONTROL_CHAR[DAU_NANG] = [
        ...
        // Circumflex (mũ) for e -> ê (ee)
        CONTROL_CHAR[DAU_MU_E] = [
            g("e"): g("ê"), g("é"): g("ế"), g("è"): g("ề"), g("ẻ"): g("ể"), g("ẽ"): g("ễ"),
            g("ẹ"): g("ệ"),
        ...
        // Circumflex (mũ) for o -> ô (oo)
        CONTROL_CHAR[DAU_MU_O] = [
            g("o"): g("ô"), g("ó"): g("ố"), g("ò"): g("ồ"), g("ỏ"): g("ổ"), g("õ"): g("ỗ"),
            g("ọ"): g("ộ"), g("ơ"): g("ô"), g("ớ"): g("ố"), g("ờ"): g("ồ"), g("ở"): g("ổ"),
            g("ỡ"): g("ỗ"), g("ợ"): g("ộ"),
        ...
        // Horn (râu) for o -> ơ (ow)
        CONTROL_CHAR[DAU_HORN] = [
            g("o"): g("ơ"), g("ó"): g("ớ"), g("ò"): g("ờ"), g("ỏ"): g("ở"), g("õ"): g("ỡ"),
            g("ọ"): g("ợ"), g("ô"): g("ơ"), g("ố"): g("ớ"), g("ồ"): g("ờ"), g("ổ"): g("ở"),
            g("ỗ"): g("ỡ"), g("ộ"): g("ợ"),
            ...
            // Horn for u -> ư (uw)
            g("u"): g("ư"), g("ú"): g("ứ"), g("ù"): g("ừ"), g("ủ"): g("ử"), g("ũ"): g("ữ"),
            g("ụ"): g("ự"),
        ...
        // d -> đ (dd)
        CONTROL_CHAR[DAU_NGANG] = [
            g("d"): g("đ"),
            g("D"): g("Đ"),
        ]
    }

    private func initVowelModifiers() {
        // Circumflex (mũ) for a -> â (aa)
        CONTROL_CHAR[DAU_MU] = [
            g("a"): g("â"), g("á"): g("ấ"), g("à"): g("ầ"), g("ả"): g("ẩ"), g("ã"): g("ẫ"),
            g("ạ"): g("ậ"), g("ă"): g("â"), g("ắ"): g("ấ"), g("ằ"): g("ầ"), g("ẳ"): g("ẩ"),
